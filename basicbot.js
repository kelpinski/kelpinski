(function () {
    ...
    API.getWaitListPosition = function(kelpinski){
    ...
    var basicBot = {
        ...
        settings: {
            ...
            lockskipPosition: 3,
            lockskipReasons: [
                ["theme", "Não é esse estilo de música, PORRA!"],
                ["op", "TÁ NA LISTA DO OP ESTA CARALHA"],
                ["history", "Já tocou essa merda "],
                ["mix", "NÃO TOCA ESSA MERDA"],
                ["sound", "Coloca alguma merda melhor, como a tua mãe "],
                ["nsfw", "PEITOS PEITOS PEITOS "],
                ["unavailable", "ESSA PORRA NÃO FUNCIONA"]
            ],
            ball: [
            "Quem sabe, tipo sua mãe aquela puta.",
            "SIM SEU VIADINHO.",
            "Vai saber, não sou enciclopédia.",
            "Sem duvidas que tu suga rolas",
            "Sua mãe diz que sim.",
            "Claro seu resto de aborto.",
            "Pode ter certeza que tua mãe mama os brodi.",
            "Melhor nem comentar o tamanho do teu brioco.",
            "Duvido muito que vai deixar de ser falho.",
            "Claro, com certeza que eu tenho uma pitanga e você não.",
            "certamente meu pau é maior que o seu.",
            "Não sei, pergunta no posto Ipiranga.",
            "Acho que sim, deve ser PORRA.",
            "Nãaaaaaaao seu viado escroto gordo.",
            "Minhas fontes dizem não, mas suas primas dizem sim.",
            "Deu erro PORRA, COME MEU CÚ."
            ],
